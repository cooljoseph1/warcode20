...
class Canvas(tkinter.Canvas):
    ...
    def __init__(self, root, map_data, border=0, *args, **kwargs):
        ...
        self.images = {
            ...
            "RED_ARCHER": self.load_image("red_archer.png"),
            "RED_HORSE": self.load_image("red_horse.png"),
            "RED_PEASANT": self.load_image("red_peasant.png"),
            "RED_PIKE": self.load_image("red_pike.png"),
            "RED_HOUSE": self.load_image("red_house.png"),
            "BLUE_ARCHER": self.load_image("blue_archer.png"),
            "BLUE_HORSE": self.load_image("blue_horse.png"),
            "BLUE_PEASANT": self.load_image("blue_peasant.png"),
            "BLUE_PIKE": self.load_image("blue_pike.png"),
            "BLUE_HOUSE": self.load_image("blue_house.png"),
        }
